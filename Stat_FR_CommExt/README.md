...
This is a set  of foreign trade datasets providing the import/export fiugures for each product and each desitination.
...
See the datasets [French_Wine_Exports_in_Kgs](https://github.com/antoinecarme/TimeSeriesData/blob/master/Stat_FR_CommExt/merged/French_Wine_Export_in_Euros.csv) and [French_Wine_Exports_in_Kgs](https://github.com/antoinecarme/TimeSeriesData/blob/master/Stat_FR_CommExt/merged/French_Wine_Export_in_Kgs.csv)
